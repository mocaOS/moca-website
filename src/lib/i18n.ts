const translations = {
  en: {
    ...
    quotaExhausted:
      "The library's monthly usage limit has been reached. It resets on {date}.",
  ...
  de: {
    ...
    quotaExhausted:
      "Das monatliche Nutzungslimit der Library ist erreicht. Es wird am {date} zurückgesetzt.",
