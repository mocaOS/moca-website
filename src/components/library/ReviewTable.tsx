...
function isUrlSubmission(s: Submission): boolean {
  return s.submission_type === "url" || (!!s.url && !s.filename);
}
                ...
                return (
                  ...
                  >
                    ...
                    <td className="px-3 py-2.5" style={{ color: "var(--fg1)" }}>
                      <div className="max-w-[240px] truncate" title={s.title || s.filename || s.url || ""}>
                        {s.title || s.filename || s.url || "Untitled"}
                      </div>
                      {isUrl
                        ? s.url && s.title !== s.url && (
                            <div className="max-w-[240px] truncate text-[11px]" style={{ color: "var(--fg3)" }} title={s.url}>
                              {s.url}
                            </div>
                          )
                    ...
                    <td className="px-3 py-2.5" style={{ color: "var(--fg2)" }}>
                      {isUrl ? (
                        s.crawl_mode === "page" ? "WEB · single page" : "WEB · whole site"
                      ) : (
                        <>
