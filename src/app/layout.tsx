...
import { RYBBIT_ENABLED, RYBBIT_SITE_ID } from "@/lib/rybbit";
  ...
  return (
    ...
    >
      <body className="antialiased">
        ...
        {/* Rybbit analytics — same-origin via next.config rewrites (ad-blocker
            resistant); auto-tracks App Router route changes. */}
        {RYBBIT_ENABLED && (
          <Script
            src="/api/script.js"
